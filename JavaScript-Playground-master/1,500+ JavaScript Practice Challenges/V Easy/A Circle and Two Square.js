...
const squareAreasDifference = r => Math.pow(2*r,2) - Math.pow(2*r,2)/2

const squareAreasDifference = r => 2 * (r ** 2)

const squareAreasDifference = r => (r+r)*r

const squareAreasDifference = r => (Math.pow(r * 2, 2)) - (Math.pow(r * 2, 2) / 2);

const squareAreasDifference = r => r*r*2;

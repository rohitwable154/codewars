...
*/
addOneToNum = function addOneToNum(number, callback) {
  var result = number + 1;
...
addOneToNum(5, function (res1) {
  addOneToNum(res1, function (res2) {
    addOneToNum(res2, function (res3) {
      addOneToNum(res3, function (res4) {
        addOneToNum(res4, function (res5) {
          console.log(res5);
        });
      });
    });
...
addOneToNumPromise = function addOneToNumPromise(number, callback) {
  var result = number + 1;
...
addOneToNumPromise(5).then(function (res) {
...
addOneToNumPromise(5).then(function (res1) {
...
addOneToNumPromise(5).then(addOneToNumPromise).then(addOneToNumPromise).then(addOneToNumPromise).then(addOneToNumPromise).then(console.log);